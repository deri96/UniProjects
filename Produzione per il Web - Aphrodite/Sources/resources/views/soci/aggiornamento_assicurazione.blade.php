...
@section('content')
    ...
    <H2>SUCCESSO!</H2>
    <h3>L'assicurazione del socio è stata aggiornata per un anno a partire dalla data odierna, ad un costo di 10 euro.<br><br>
                Per scaricare il documento correlato al pagamento del rinnovo dell'assicurazione visiona la sezione sottostante<br><br>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>Documento per la ricevuta del pagamento effettuato dal socio per il rinnovo dell'assicurazione</td>
                    <td>
