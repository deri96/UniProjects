...
public class NuovoCliente extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		output.println(ServletLayout.getNuovoClientePage(error));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query = "INSERT INTO Cliente(Email, Password, Nome, Cognome, Indirizzo, DataNascita)" +
					"VALUES (?, ?, ?, ?, ?, ?)";
		...
		response.sendRedirect(request.getContextPath() + "/nuovoCliente");
		return;
	}
