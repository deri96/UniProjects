...
if (isset($_POST['globetrotter'])) {

	// definizione dei vari campi da quelli passati in post
	$username = $_POST ['globetrotter'];

	// definizione della lista degli eventi iscritti
    $subscribed_list = $db->get_events_subscribed($username);
	...
	if ($subscribed_list != null) {
		...
		$response ["events"] = $subscribed_list;
