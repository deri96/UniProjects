...
if (isset($_POST['event_id']) && isset($_POST['description']) && 
	...
	$is_stored = $db->update_event($event_id, $description, $max_subscription, $start_date, $end_date);
	...
	if ($is_stored) {
		...
		foreach($languages as $language) 
			$db->store_event_spoken_language($event_id, $language);
